...
public class ActionPanel extends JPanel {
	...
	public ActionPanel() {
		...
		try {
			...
			exchangeDice.setBounds(820, 10, 120, 30);
			exchangeDice.setBackground(Color.blue);
			exchangeDice.setForeground(Color.white);
			this.add(exchangeDice);
			
			
			setLayout(null);
			seeOtherBoard.setBounds(950, 10, 150, 30);
	...
	public void button() {
		...
		gainFoodBtn.addActionListener((e) -> {

		});
		layEggsBtn.addActionListener((e) -> {

		});
		drawCardsBtn.addActionListener((e) -> {

		});
		playBirdBtn.addActionListener((e) -> {

		});
		exchangeFood.addActionListener((e) -> {

		});
		exchangeDice.addActionListener((e) -> {

		});
		exchangeCard.addActionListener((e) -> {

		});
		rerollDice.addActionListener((e) -> {
